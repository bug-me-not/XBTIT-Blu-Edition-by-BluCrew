...
$language['BLOCK_DISCALIMER']='Disclaimer';

$language["BLOCK_HIT"]="Hit & Run Warns"; # changed HIT & RUN Warning for proper block display
...
# Sport Betting
$language['BLOCK_BET'] = "Sport Betting";

# Upload Medals
$language["BLOCK_TOPU"]="Top Uploaders";

# Circling Last Torrents
$language['BLOCK_LASTTORRENTSC'] = "Last Torrents";

# Low Ratio Warn & Ban System
$language["BLOCK_LRB"]="Ratio Warn & Ban";# changed Low Ratio Warns & Bans for proper block display
...
$language['BLOCK_LAST_DOWN']='Last Downloads';

$language["BLOCK_TOW"]="Torrent of the week";
$language["ACP_CAPTCHA_CONF"]='Comment Captcha';
...
#Ajax Chat
$language["BLOCK_AJAX_CHAT"]="Ajax Chat";

#SeedBox
$language['BLOCK_SB']='Seedbox';

#Latest Requests
$language['BLOCK_LAST_REQUEST']='Latest Requests';
$language['LAST_REQUEST']='Latest Requests';

#Search
$language['BLOCK_SEARCH']='Search';
$language['LATEST_RELEASES']="Latest Releases";
