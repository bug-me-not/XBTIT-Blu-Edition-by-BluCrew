...
<head>
    ...
    <!-- php.js -->
	<script src="{$smarty.const.BASEURL}/js/phpjs.js" type="text/javascript"></script>
	...
	<link href="{$smarty.const.BASEURL}/css/font-awesome.min.css" rel="stylesheet">	
					...
					<div class="tab-pane" id="permissions">	
						{if $permissionErrors|@count gt 0}
							...
							{foreach from=$permissionErrors item=error}
							    <li><i style="color: #A94442;" class="fa fa-exclamation-triangle"></i> {$error}</li>
							{/foreach}
						{else}
