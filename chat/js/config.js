...
var ajaxChatConfig = {
	...
	bbCodeTags: ['b','i','u','quote','code','color','url','img','youtube','guest','user','superleech','leech','recruit','bluuser','bluwarrior','blumaster','bluaddict','blujunkie','blugod','uploader','vip','trustee','blurg','moderator','admin','chatBot'],
	...
	emoticonCodes: [':wave:',':ras:',':blink:',':blum:',':blush:',':confused:',':grin:',':hmm:',':hmmm:',':innocent:',':laugh:',':popcorn2:',':rolleyes:',':smile1:',':smile2:',':tongue:',':unsure:',':w00t:',':whistle:',':wink:',':yawn:',':book:',':shifty:',':zorro:',':ninja:'],

 	// Defines the list of emoticon files associated with the emoticon codes:
	emoticonFiles: ['wave.gif','ras.gif','blink.gif','blum.gif','blush.gif','confused.gif','grin.gif','hmm.gif','hmmm.gif','innocent.gif','laugh.gif','popcorn2.gif','rolleyes.gif','smile1.gif','smile2.gif','tongue.gif','unsure.gif','w00t.gif','whistle.gif','wink.gif','yawn.gif','book.gif','shifty.gif','zorro.gif','ninja.gif'],

	// Defines the available sounds loaded on chat start:
	soundFiles: { sound_1: 'sound_1.mp3', sound_2: 'sound_2.mp3', sound_3: 'sound_3.mp3', sound_4: 'sound_4.mp3', sound_5: 'sound_5.mp3', sound_6: 'sound_6.mp3'},
