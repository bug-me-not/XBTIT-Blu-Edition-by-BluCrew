...
function template_main()
{
	...
	if (!empty($context['members']))
	{
		...
		if (!isset($context['disabled_fields']['website']))
			echo '
					<td class="windowbg hidden-xs hidden-sm">', $member['website']['url'] != '' ? '<a href="' . $member['website']['url'] . '" target="_blank" class="new_win"><img src="' . $settings['images_url'] . '/www.gif" alt="' . $member['website']['title'] . '" title="' . $member['website']['title'] . '" /></a>' : '', '</td>';
