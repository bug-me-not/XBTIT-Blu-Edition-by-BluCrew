...
<tr>
      <td class="header" valign="top" colspan="1"><tag:language.HNR_SCROLLING_TEXT /></td>
      <td class="lista" colspan="3"><textarea name="scrol_tekst" rows="5" cols="60"><tag:hrbconfig.scrol_tekst /></textarea></td>
    </tr>
    <tr>
      <td class="header"><tag:language.HNR_COUNT /></td>
