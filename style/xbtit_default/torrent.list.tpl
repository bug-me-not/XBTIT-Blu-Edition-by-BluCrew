...
<div class="panel panel-primary">
  ...
  <ul>
    <div align="center">
      ...
      <if:swit><td class="block" style="text-align:left;"><a href='account_change.php?tds=<tag:switch />'><div id="div"><img src="images/switch.png" />Use <tag:switch /> Torrent Details style</div></a></td></if:swit>
