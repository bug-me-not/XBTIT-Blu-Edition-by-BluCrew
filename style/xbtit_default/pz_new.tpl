...
<form action='<tag:url />' method='post' target="_blank">
...
<input type="hidden" name="ap_amount" value="(place your amount here)">
<if:ipn_en_3>
...
<center><input type="image" src="https://secure.payza.com/PayNow/E48625875F58425492B1226EE1CA165Ad9en.gif" border="0" name="pz_image" alt="Secure checkout with Payza"></center><br />
</form>                    
</td>
            <td><br />
            	<center><font size="1.5px"><span style='color:red'><tag:language.DONATE_1 /> (place your amount here) <tag:sign /> <tag:language.RECEIVE /></span></font></center>             
...
<center><input type="image" src="https://secure.payza.com/PayNow/E48625875F58425492B1226EE1CA165Ad9en.gif" border="0" name="pz_image" alt="Secure checkout with Payza"></center></b><br />
</form>			 
			 </td>
			 <td> <br />      	
<center><font size="1.5px"><span style='color:red'>Freeleech (place your amount here) <tag:sign /></span></font></center>
