...
// -->
  ...
  <table width="100%" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <tr>
        <td align="left"><input type="button" class="btn btn-sm btn-primary" name="code" value="Code" onclick="javascript: BBTag('[code]','[/code]',document.forms.<tag:form_name />.<tag:object_name />)" /></td>
        <td align="left"><input type="button" class="btn btn-sm btn-primary" name="quote" value="Quote" onclick="javascript: BBTag('[quote]','[/quote]',document.forms.<tag:form_name />.<tag:object_name />)" /></td>
        <td align="left"><input type="button" class="btn btn-sm btn-primary" name="url" value="Url" onclick="javascript: BBTag('[url]','[/url]',document.forms.<tag:form_name />.<tag:object_name />)" /></td>
        <td align="left"><input type="button" class="btn btn-sm btn-primary" name="img" value="Img" onclick="javascript: BBTag('[img]','[/img]',document.forms.<tag:form_name />.<tag:object_name />)" /></td>
        <td align="left" style="height:25px;"><input type="button" class="btn btn-sm btn-primary" name="noparse" value="NoParse" onclick="javascript: BBTag('[noparse]','[/noparse]',document.forms.<tag:form_name />.<tag:object_name />)" /></td>
        <td align="left" style="height:25px;"><input type="button" class="btn btn-sm btn-primary" name="br" value="br" onclick="javascript: BBTag('[br]','',document.forms.<tag:form_name />.<tag:object_name />)" /></td>
     	  <td align="left" style="height:25px;"><input type="button" class="btn btn-sm btn-primary" name="li" value="*" onclick="javascript: BBTag('[*]','',document.forms.<tag:form_name />.<tag:object_name />)" /></td>
     	  <td align="left" style="height:25px;"><input type="button" class="btn btn-sm btn-primary" name="hr" value="hr" onclick="javascript: BBTag('[hr]','',document.forms.<tag:form_name />.<tag:object_name />)" /></td>
        <td align="left"><input type="button" class="btn btn-sm btn-primary" name="email" value="Email" onclick="javascript: BBTag('[email]','[/email]',document.forms.<tag:form_name />.<tag:object_name />)" /></td>
        <td align="left"><input type="button" class="btn btn-sm btn-primary" name="spoiler" value="Spoiler" onclick="javascript: BBTag('[Spoiler]','[/Spoiler]',document.forms.<tag:form_name />.<tag:object_name />)" /></td>
...
<tr><td valign="top">
    ...
    <tr>
      <td>
      <textarea name="<tag:object_name />" rows="15" style="width:96%" onselect="storeCaret(this);" onclick="storeCaret(this);" onkeyup="storeCaret(this);" onchange="storeCaret(this);" class="form-control"><tag:content /></textarea>
      </td>
    </tr>
		<tr>
      <td><center>
