...
<body>	
			...
			<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">	
				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">	
					...
					<div class="table"  id="services_table">
						<div class="header dark">
							<div class="cell_mobile">Status</div>
							<div class="cell_mobile">Service</div>
							<div class="cell_mobile">Port</div>
						</div>		
					</div>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">	
					<div class="table" id="disk_table">
						<div class="header jeans-blue">
							<div class="cell_mobile">HDD Mount</div>
							<div class="cell_mobile">Used</div>
							<div class="cell_mobile">Free</div>
							<div class="cell_mobile">Total</div>
						</div>
					</div>
					...
					<div class="table" id="network_table">
						<div class="header surf-green">
							<div class="cell_mobile">Network</div>
							<div class="cell_mobile">IP</div>
							<div class="cell_mobile">Receive</div>
							<div class="cell_mobile">Transmit</div>
						</div>
					</div>
	...
	$(document).ready(function(){ serverInfo(scriptDir);  setInterval( function() { serverLoad(scriptDir) }, 60000 ); /* Get server load every 60 seconds */});
