...
function load_lang_file()
{
    ...
    if(empty($GLOBALS["find_install_lang"]))
    {
        ...
        echo ("<title>XBTIT Blu-Edition Installer - Language Error</title>");
        echo ("<link rel=\"stylesheet\" href=\"style/xbtit_default/bootstrap.css\" type=\"text/css\" />");
        echo ("</head>");
...
function step($text = '', $stepname = '', $stepnumber = '')
{
    ...
    echo ("<ul class=\"breadcrumb\">
           <li class=\"active\">".$stepname."&nbsp;(".$stepnumber."/5)</li>
           </ul></div></div>");
    ////////// main block //////////
    echo ("<div class=\"container\">
           <div class=\"row\">");
...
if(file_exists(dirname(__file__)."/install.lock"))
{
    echo ("<div class=\"container\">
        ...
        <strong>For security reasons, this installer is locked! Please (via FTP) remove or change the 'install.lock' file before continue.</strong>
        </div>
        </div>
        </div>
        </div>");
...
if($action == 'welcome')
{
    step($install_lang["welcome_header"], $install_lang["step"]."&nbsp;".$install_lang["welcome_header"], "0");
    echo ("<div class=\"panel panel-primary\">
           <div class=\"panel-heading\">
           <h4 class=\"text-center\">".$install_lang["welcome"]."</h4>
           </div>");
...
elseif($action == 'reqcheck')
{
    ...
    echo ("<div class=\"panel panel-primary\">
           <div class=\"panel-heading\">
           <h4 class=\"text-center\">".$install_lang["requirements_check"]."</h4>
           </div>");
    echo ("<table class=\"table table-bordered\">");
    ...
    echo ("</table><div class=\"panel-footer\"></div></div>");
...
elseif($action == 'settings')
{
    ...
    echo ("<div class=\"panel panel-primary\">
           <div class=\"panel-heading\">
           <h4 class=\"text-center\">Database Settings</h4>
           </div>");
    echo ("<table class=\"table table-bordered\">");
