 ...
 *
 *
 *	[1] [URL]http://www.adventuresinsoftware.com/blog/?p=104#comment-1981[/URL]
 *	[2] [URL]http://shoutbox.finnrudolph.de/[/URL]
 *	[3] [URL]http://reflection.corephp.co.uk/v2.php[/URL]
 *	[4] [URL]http://adomas.org/javascript-mouse-wheel/[/URL]
 */
...
function refresh(onload)
{
	...
	{ 
		...
		if (image.nodeType == 1)
		{
			...
			image.ondblclick = function() { window.open(this.url,'_blank'); }
