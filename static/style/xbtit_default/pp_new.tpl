...
<center><input type="image" src="images/btn_donateCC_LG.gif" border="0" name="I1" alt="Make payments with PayPal - it's fast, free and secure!"></center><br />
</form>
...
<center><input type="image" src="images/btn_donateCC_LG.gif" border="0" name="I1" alt="Make payments with PayPal - it's fast, free and secure!"></center></b><br />
</form>		 
			 </td>
			 <td>&nbsp;
			 <center><font size="1.5px"><span style='color:red'>Freeleech (place your amount here) <tag:sign /></span></font></center>
