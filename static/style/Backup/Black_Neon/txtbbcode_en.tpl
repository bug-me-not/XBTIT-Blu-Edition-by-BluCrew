...
<td align="left"><select onchange="BBTag('[' + this.options[this.selectedIndex].value + ']', '[/align]', document.forms.<tag:form_name />.<tag:object_name />); this.selectedIndex = 0;" size="1" style="background:#000;" name="videoalignment">
              <option value="" selected="selected">Video Alignment</option>
              <option value="align=left">Left</option>
              <option value="align=center">Center</option>
              <option value="align=right">Right</option>
              </select></td>
<td align="left"><select onchange="BBTag('[' + this.options[this.selectedIndex].value, ']', document.forms.<tag:form_name />.<tag:object_name />); this.selectedIndex = 0;" size="1" style="background:#000;" name="videotype">
...
<tr><td valign="top">
        <table width="50%" cellpadding="0" cellspacing="5" align="left">
              ...
              <option value="larger">larger</option>
                 ...
                 <td align="left" style="text-align:left;"><select onchange="BBTag('[color=' + this.options[this.selectedIndex].value.toLowerCase() + ']','[/color]', document.forms.<tag:form_name />.<tag:object_name />); this.selectedIndex = 0;" size="1" style="background:#292929;" name="fontchange">
              <option value="" selected="selected">Text Color</option>
              <option value="Black" style="color:black; background:Gray">Black</option>
              ...
              <option value="Yellow" style="color:Yellow">Yellow</option>
                 ...
                 <td align="left" style="text-align:left;"><select onchange="BBTag('[bg-color=' + this.options[this.selectedIndex].value.toLowerCase() + ']','[/bg-color]', document.forms.<tag:form_name />.<tag:object_name />); this.selectedIndex = 0;" size="1" style="background:#000;" name="fontchange">
...
<tr><td valign="top">
        <table width="65%" cellpadding="0" cellspacing="5" align="left">
                <td align="left"><select onchange="BBTag('[' + this.options[this.selectedIndex].value.toLowerCase() + ']','[/' + this.options[this.selectedIndex].value.toLowerCase() + ']', document.forms.<tag:form_name />.<tag:object_name />); this.selectedIndex = 0;" size="1" style="background:#000;" name="fontchange">
              ...
              <option value="pre">preformatted</option>
                ...
                <td align="left"><select onchange="BBTag('[' + this.options[this.selectedIndex].value + ']', '[/scroll]', document.forms.<tag:form_name />.<tag:object_name />); this.selectedIndex = 0;" size="1" style="background:#000;" name="scroll">
              ...
              <option value="scroll=down">Scroll Down</option>
                ...
                <td align="left"><select onchange="BBTag('[' + this.options[this.selectedIndex].value + ']\n[*]\n[*]\n[/list]', '', document.forms.<tag:form_name />.<tag:object_name />); this.selectedIndex = 0;" size="1" style="background:#000;" name="fontchange">
